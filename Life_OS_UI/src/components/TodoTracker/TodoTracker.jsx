                  ...
                  {showInput[mIndex] ? (
                      <div className="add-task-input-group">
                          <input 
                              ...
                              onChange={(e) => setNewTaskInput({...newTaskInput, [mIndex]: e.target.value})}
                              onKeyDown={(e) => e.key === 'Enter' && handleAddTask(mIndex)}
                          />
                          <button onClick={() => handleAddTask(mIndex)} className="add-btn">+</button>
                          <button onClick={() => toggleInputVisibility(mIndex)} className="cancel-btn">x</button>
                      </div>
                  ) : (
                      <button 
