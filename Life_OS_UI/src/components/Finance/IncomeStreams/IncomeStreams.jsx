...
import { STREAM_TYPES } from '../../../services/defaults';
            ...
            <div className="income-group" key={typeKey}>
                    ...
                    <span className="group-total font-mono font-bold">
                        ...
                        {groupTarget > 0 && (
                            <span className="text-xs text-gray-400 font-normal">
                                {' '}
                                / ${groupTarget.toLocaleString()} goal
                            </span>
                        )}
                    </span>
                </div>
                {group.map((stream, idx) => (
                    <div
                        ...
                        style={{ opacity: typeKey === 'ignored' ? 0.6 : 1 }}
                    >
                        <div className="stream-header">
                            <div className="flex items-center gap-2 flex-1">
                                ...
                                <input
                                    ...
                                    value={stream.alias}
                                    onChange={(e) =>
                                        updateConfig(stream.name, 'alias', e.target.value)
                                    }
                        ...
                        >
                            <div className="stat-block">
                                ...
                                <span
                                    className={`amount ${typeKey === 'ignored' ? 'text-gray-500' : 'text-green-700'}`}
                                >
                                    $
                                    {stream.monthlyAvg.toLocaleString(undefined, {
                            ...
                            {typeKey !== 'ignored' && (
                                <div className="stat-block text-right">
                                    ...
                                    <input
                                        ...
                                        value={stream.target}
                                        onChange={(e) =>
                                            updateConfig(stream.name, 'target', e.target.value)
                                        }
                        ...
                        {expandedStream === stream.name && (
                            <div className="mt-4 pt-3 border-t border-[var(--border-color)]">
                                <p className="text-xs font-bold text-[var(--text-secondary)] mb-2 uppercase">
