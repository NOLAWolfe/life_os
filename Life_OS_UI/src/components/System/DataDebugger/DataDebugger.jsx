            ...
            <header className="flex justify-between items-end border-b border-[var(--border-color)] pb-4">
                <div>
                    ...
                    <p className="text-sm text-[var(--text-secondary)]">
                        System Integrity & Logic Audit
                    </p>
                </div>
                <div className="text-[10px] uppercase font-bold text-gray-500">
                    Source: <span className="text-blue-400">SQLite Database</span>
                </div>
            </header>
            ...
            <div className="animate-fade-in space-y-8">
                ...
                <div className="bg-[var(--bg-secondary)] rounded-lg p-6 border border-[var(--border-color)]">
                    ...
                    <p className="text-sm text-[var(--text-secondary)] mb-4">
                        Transactions matching keywords like 'Zelle', 'Transfer', or 'CC Payment' are
                        flagged to prevent skewed income/expense data.
                    </p>
                        ...
                        <table className="w-full text-left text-xs">
                            ...
                            <tbody>
                                {lateralTxns.map((t, idx) => (
                                    <tr
                                        key={idx}
                                        className="border-t border-[var(--border-color)] hover:bg-white/5"
                                    >
