...
*Target: Early adopters and "Spreadsheet Refugees".*
*   **Free (The Ledger):** Manual entry, legacy CSV support, basic spending charts.
    *   *Monetization:* **High-Value Affiliates.** (e.g., "Switch to this HYSA" offers).
*   **Pro ($7.99/mo | $79/yr):** 
...
*   **Business Hub ($49.99/mo):** 
    *   *The Profit Engine: One client covers 100% of initial fixed costs.*
...
*Target: Power users and specialized professionals (DJs/Agents).*
*   **Pro ($12.99/mo):** 
...
*Target: The "10X" Lifestyle Entrepreneur.*
...
*We do not do "Banner Ads". We do "Wealth Optimization".*
...
*Goal: Keep fixed costs <$30/mo until 500 users.*
