        ...
        const stories = [
            {
                ...
                description: "As a security-conscious user, I want all sensitive bank data (account numbers, real names) to be masked before it hits the database so that I can demo the app safely.",
                state: "Active",
                assignedTo: "Neauxla",
                acceptanceCriteria: "1. All account numbers are masked.\n2. Raw vendor descriptions are scrubbed of personal names.\n3. Logic is implemented in mappingService.js."
            },
            {
                title: "Refactor Professional Hub to Prisma/SQLite",
                description: "The current JSON-based storage is not scalable for enterprise use. We need to migrate to a relational database to support complex queries and future Azure DevOps integration.",
                state: "Closed",
                assignedTo: "Gemini AI",
                acceptanceCriteria: "1. Remove legacy JSON files.\n2. Create qaRepository.js.\n3. Verify CRUD operations via frontend."
            },
            {
                title: "Integrate Azure DevOps Integration Connector (Phase 3)",
                description: "To enable bi-directional sync with corporate environments, we need to leverage the Google Cloud Integration Connectors for ADO.",
                state: "New",
                assignedTo: "Unassigned",
                acceptanceCriteria: "1. Configure OAuth in Google Cloud Console.\n2. Implement ADO sync logic in professional_engine.\n3. Support webhook updates for ticket states."
            },
            {
                title: "Build 'Sorting Hat' Transaction Classifier UI",
                description: "Users need a fast, intuitive way to assign orphaned transactions to Bill Nodes. This 'Tinder for Finance' interface will gamify the cleanup process.",
                state: "Active",
                assignedTo: "Neauxla",
                acceptanceCriteria: "1. Render unassigned transactions.\n2. Allow manual mapping to Bill nodes.\n3. Persist rules to SQLite."
            }
        ];
